...
python3 ${CMSSW_BASE}/src/RPCDPGAnalysis/NanoAODTnP/scripts/rpc-tnp-flatten-nanoaod.py \
        ...
        -o /u/user/sjws5411/Workspace/Efficiency/CMSSW_14_1_0_pre2/src/Workspace-RPC/240415-submit_crab_tnp_nanoaod2/step2-condor_flatten/Muon__Run2022G/output/flatten_$(basename $1)
