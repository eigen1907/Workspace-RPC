...
python3 ${CMSSW_BASE}/src/RPCDPGAnalysis/NanoAODTnP/scripts/rpc-tnp-flatten-nanoaod.py \
        ...
        -o /u/user/sjws5411/Workspace/Efficiency/CMSSW_14_1_0_pre2/src/Workspace-RPC/240412/step2-condor-slc7_amd64_gcc12-1410pre2/Muon1__Run2023D/output/flatten_$(basename $1)
